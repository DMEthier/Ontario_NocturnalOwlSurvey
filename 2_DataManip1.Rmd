...
in.data<-read.csv("Data/2026/ONOWLS_20Jan2026.csv")
...
write.csv(owldata, "Data/2026/owldata_2026.csv")
owldata<-read.csv("Data/2026/owldata_2026.csv")
...
length(unique(boowc[boowc$yr==2026,"RouteIdentifier"])) #number of routes sampled in central Ontario
length(unique(boown[boown$yr==2026,"RouteIdentifier"])) #number of routes sampled in northern Ontario
sum(boowc[boowc$yr==2026,"Tstn"]) #number of stops sampled in central Ontario
sum(boown[boown$yr==2026,"Tstn"]) #number of stops sampled in northern Ontario

```

```{r saveindividualdata, echo = FALSE, message = FALSE}

write.csv(nswoc, "Data/2026/nswoc.csv")
write.csv(ggowc, "Data/2026/ggowc.csv")
write.csv(ghowc, "Data/2026/ghowc.csv")
write.csv(barrc, "Data/2026/barrc.csv")
write.csv(boowc, "Data/2026/boowc.csv")

write.csv(nswon, "Data/2026/nswon.csv")
write.csv(ggown, "Data/2026/ggown.csv")
write.csv(ghown, "Data/2026/ghown.csv")
write.csv(barrn, "Data/2026/barrn.csv")
write.csv(boown, "Data/2026/boown.csv")
...
write.csv(otherdata, "Data/2026/otherdata_2026.csv")
otherdata<-read.csv("Data/2026/otherdata_2026.csv")
...
write.csv(rugrc, "Data/2026/rugrc.csv")
write.csv(wisnc, "Data/2026/wisnc.csv")
write.csv(amwoc, "Data/2026/amwoc.csv")

write.csv(rugrn, "Data/2026/rugrn.csv")
write.csv(wisnn, "Data/2026/wisnn.csv")
write.csv(amwon, "Data/2026/amwon.csv")
