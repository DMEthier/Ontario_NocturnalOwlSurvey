...
p <- ggplot() +
  ...
  coord_sf() +
  scale_color_brewer(palette = "Dark2", name = "Survey area") +
  scale_shape_discrete(name = "Survey area") +
  labs(x = "Longitude", y = "Latitude",
       title = "Nocturnal Owl Survey Routes 2025") +
  theme_classic()

jpeg(file.path(plot.dir, "Route2025_Owls.jpg"),
