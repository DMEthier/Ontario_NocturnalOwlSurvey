...
index<-read.csv("Annual indices for Ontario Owls 1995-2024.csv")
...
trends<-read.csv("Trends for Ontario Owls 1995-2024.csv")
...
ggplot()+
  geom_line(data=plot2, aes(x=YearCollected, y=value, colour=region), size=1)+
  theme_classic(base_size = 20)+
  theme(legend.text=element_text(size=16), 
